 ...
 * `<a target="_blank">`-Klick zu verlassen -- damit bleibt die eCamper-App
 ...
 * Hintergrund, waehrend die eCamper-App selbst weiterlaeuft -- die
  ...
  return (
    <button
      ...
      onClick={() =>
        ...
        // einen neuen Tab, ohne den eCamper-Tab zu verlassen.
        window.open(href, `ecamper-navigation-${Date.now()}`, "noopener,noreferrer")
      }
      className={className}
    >
      {children}
